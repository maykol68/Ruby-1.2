...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  test 'render a list of products' do
    ...
    assert_select '.categorium', 9
  end

  test 'render a list of products filtered by categorium' do
    get products_path(categorium_id: categoria(:computers).id)
  ...
  test 'allows to create a new product' do
    post products_path, params: {
      product: {
        ...
        price: 45,
        categorium_id: categoria(:videogames).id
      }
    }
